...
// list of golfers, converted to "First Last". Admin only.
//
// POST /api/parse-team  body: { adminKey, imageBase64, mediaType }
// ============================================================
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { adminKey, imageBase64, mediaType } = body || {};

    // Only admins (you + Brian) can use this
